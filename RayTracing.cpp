...
void RayTracing::CreateTopLevelAccelerationStructureForScene(std::shared_ptr<GameEntity> entity)
{
	...
	DirectX::XMFLOAT4X4 transform = entity->get_transform().GetWorldMatrix();
	...
	instanceDesc.AccelerationStructure = entity->get_mesh()->get_raytracing_data().BLAS->GetGPUVirtualAddress();
